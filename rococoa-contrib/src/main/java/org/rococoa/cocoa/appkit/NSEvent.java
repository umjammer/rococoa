...
public abstract class NSEvent extends NSObject implements NSCopying {
    ...
    public interface _Class extends ObjCClass {
         ...
         */
        NSEvent eventWithEventRef(Pointer eventRef);
         ...
         */
        NSEvent eventWithCGEvent(Pointer eventRef);
    ...
    public abstract NSPoint mouseLocation();
    ...
    public static final long NSEventMaskGesture = 1L << NSEventTypeGesture;
    public static final long NSEventMaskMagnify = 1L << NSEventTypeMagnify;
    public static final long NSEventMaskSwipe = 1L << NSEventTypeSwipe;
    public static final long NSEventMaskRotate = 1L << NSEventTypeRotate;
    public static final long NSEventMaskScrollWheel = 1L << NSEventTypeScrollWheel;
}