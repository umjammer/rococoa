...
public abstract class VNHumanBodyPoseObservation extends VNRecognizedPointsObservation {
    ...
    private static final Logger logger = Logger.getLogger(VNHumanBodyPoseObservation.class.getName());

    public static final _Class CLASS = Rococoa.createClass("VNHumanBodyPoseObservation", _Class.class);
